...
//Test data generator
	...
	public static Collection<String[]> data() throws IOException {
		core.MyHtmlUnit htmlunit = new core.MyHtmlUnit();
		return Arrays.asList(htmlunit.a2dim());	
	}
	// @Parameter for Filed injection instead of Constructor
	@Parameter(value=0)
	...
	@Test
	public void test_Title_Validation_HtmlUnit() throws ComparisonFailure {
